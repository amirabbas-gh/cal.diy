...
export default function Credits() {
  ...
  return (
    <small className="text-default mx-3 mb-2 mt-1 hidden text-[0.5rem] opacity-50 lg:block">
      ...
      <a href="https://go.cal.com/credits" target="_blank" className="hover:underline">
        {COMPANY_NAME}
      </a>{" "}
      {hasMounted && (
        <>
          <a href="https://go.cal.com/releases" target="_blank" className="hover:underline">
            {CalComVersion}
          </a>
          {vercelCommitHash && IS_CALCOM ? (
            <Link
              to={`https://github.com/calcom/cal.diy/commit/${vercelCommitHash}`}
              target="_blank"
