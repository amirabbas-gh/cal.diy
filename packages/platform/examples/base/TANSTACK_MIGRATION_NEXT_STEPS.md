...
- **Package root (this manifest):** `packages/platform/examples/base`
...
- `file=app/refer/index.tsx`: **1**
- `file=app/apps/categories/index.tsx`: **1**
- `file=app/apps/$slug/index.tsx`: **1**
- `file=app/$.tsx`: **1**
- `file=app/apps/categories/$category.tsx`: **1**
...
- `module=next/document`: **2**
- `module=next/server`: **1**
- `module=next/router`: **3**
- `module=next`: **3**
- `module=next/navigation`: **1**
- `module=next/script`: **5**
