...
function Home(props: { calUsername: string; calEmail: string }) {
  ...
  return (
    <main className={"flex min-h-screen flex-col items-center justify-center"}>
      ...
      <div
        className={"h-screen w-full items-center justify-center gap-y-3 font-mono lg:flex gap-16"}>
        <div className="ml-32">
          <h1 className={"w-full pb-3 text-7xl font-bold"}>
            The all in one Scheduling marketplace
          </h1>
          <p className={"w-[70%] font-normal pb-3 text-2xl"}>
