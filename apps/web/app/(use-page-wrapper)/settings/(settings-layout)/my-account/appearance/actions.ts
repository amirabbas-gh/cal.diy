...
export const revalidateSettingsAppearance = createServerFn().handler(async () => {
  queryClient.invalidateQueries({ queryKey: ['next-cache', 'path', "/settings/my-account/appearance"] });
});
